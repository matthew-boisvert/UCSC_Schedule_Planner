...
def add_class_to_calendar(service, db_row, attendees=None, location=None):
    ...
    add_event_to_calendar(service, first_day_info["start"], first_day_info["end"], meeting_days, quarter_end, db_row.class_name, attendees, "This event was generated by the UCSC Schedule Planner", "Santa Cruz, California")
...
def main():
    ...
    add_class_to_calendar(service, controller.find_course(course_name="CSE 138"), "mboisver@ucsc.edu", "Santa Cruz, California")
